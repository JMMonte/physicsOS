...
This audit was peer-reviewed under [AGENTS.md §2.6](../../AGENTS.md#26-peer-review). Pre-sandbox reports in [`round0/`](round0/) (see `round0/_NOTE.md` for the isolation caveat). Findings and resolution:
